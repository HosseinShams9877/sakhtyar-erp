  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <main className="flex-1 min-h-screen flex flex-col pb-16 lg:pb-0">
        {/* ─── Desktop Top Bar ─── */}
        <header className="hidden lg:flex items-center justify-between h-14 px-6 border-b border-border bg-card sticky top-0 z-30 shrink-0">
        ...
        {/* ─── Mobile Top Bar ─── */}
        <header className="lg:hidden h-12 flex items-center gap-2 px-3 border-b border-border bg-card sticky top-0 z-30 shrink-0">
          <button onClick={() => setSidebarOpen(true)} className="p-1.5 hover:bg-muted rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm">ساخت‌یار</span>
          </div>
          {/* Spacer */}
